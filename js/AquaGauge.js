...
function GaugeParams(cvs) {
    ...
    //Scale Ranges
    this.rangeSegments = [{ start: 0, end: 4, color: "greenyellow" },
                          { start: 4, end: 7.5, color: "yellow" },
                          { start: 7.5, end: 10, color: "red"}];
