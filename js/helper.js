...
function setupSmallGauge(sGauge) {
    ...
    sGauge.props.maxValue = 30;
    sGauge.props.noOfDivisions = 6;
    sGauge.refresh(5);
}

function setupWhiteGauge(wGauge) {
    wGauge.props.maxValue = 100;
    wGauge.props.rangeSegments = [{ start: -100, end: 20, color: "greenyellow" },
                                      { start: 20, end: 60, color: "yellow" },
                                      { start: 60, end: 100, color: "red"}];
    wGauge.props.dialColor = "#fff";
    wGauge.props.dialGradientColor = "#fff";
    wGauge.props.noOfDivisions = 5;
    wGauge.props.noOfSubDivisions = 2;
    wGauge.props.majorDivisionColor = "black";
    wGauge.props.minorDivisionColor = "red";
    wGauge.props.dialTitle = "Strain";
    wGauge.props.dialSubTitle = "KN*mm";
...
function setupGXGauge(sGauge) {
    sGauge.props.dialColor = "Gray";
    sGauge.props.dialGradientColor = "#fff";
    sGauge.props.dialScaleFont = "bold 10px Trebuchet MS";
    sGauge.props.dialTitle = "Acceleration X";
    sGauge.props.dialTitleTextFont = "bold 12px Calibri";
    sGauge.props.dialValueTextFont = "bold 14px Arial Black";
    sGauge.props.dialSubTitle = "G";
    sGauge.props.rimWidth = "3";
    sGauge.props.dialSubTitleTextFont = "10px Tahoma";
    sGauge.props.rangeSegments = [{ start: -1, end: 1, color: "greenyellow" },
                                      { start: -2, end: -1, color: "redyellow" },
          
                                      { start: 1, end: 2, color: "yellowred"}];
                               
    sGauge.props.pointerColor = "red";
    sGauge.props.pointerGradientColor = "maroon";
    sGauge.props.maxValue = 2;
    sGauge.props.noOfDivisions = 8;
    sGauge.refresh(0.5);
}

function setupGYGauge(sGauge) {
    sGauge.props.dialColor = "Gray";
    sGauge.props.dialGradientColor = "#fff";
    sGauge.props.dialScaleFont = "bold 10px Trebuchet MS";
    sGauge.props.dialTitle = "Acceleration Y";
    sGauge.props.dialTitleTextFont = "bold 12px Calibri";
    sGauge.props.dialValueTextFont = "bold 14px Arial Black";
    sGauge.props.dialSubTitle = "G";
    sGauge.props.rimWidth = "3";
...
function setupGZGauge(sGauge) {
    sGauge.props.dialColor = "Gray";
    sGauge.props.dialGradientColor = "#fff";
    sGauge.props.dialScaleFont = "bold 10px Trebuchet MS";
    sGauge.props.dialTitle = "Acceleration Z";
    sGauge.props.dialTitleTextFont = "bold 12px Calibri";
    sGauge.props.dialValueTextFont = "bold 14px Arial Black";
    sGauge.props.dialSubTitle = "G";
    sGauge.props.rimWidth = "3";
...
function setupDGauge(sGauge) {

    sGauge.dialColor = "rgba(255, 100, 00, 0.8)";
    sGauge.props.dialGradientColor = "#fff";
    sGauge.props.dialScaleFont = "bold 10px Trebuchet MS";
    sGauge.props.dialTitle = "Wind Direction";
    sGauge.props.dialTitleTextFont = "bold 12px Calibri";
    sGauge.props.dialValueTextFont = "bold 14px Arial Black";
    sGauge.props.dialSubTitle = "Degree";
    sGauge.props.rimWidth = "3";
    sGauge.props.dialSubTitleTextFont = "10px Tahoma";
    sGauge.props.rangeSegments = [];
    sGauge.props.pointerColor = "red";
    sGauge.props.pointerGradientColor = "maroon";
    sGauge.props.maxValue = 360;
    sGauge.props.noOfDivisions = 6;
    sGauge.refresh(5);

}

function setupTGauge(sGauge) {
    sGauge.props.dialColor = "#ff9900";
    sGauge.props.dialGradientColor = "#fff";
    sGauge.props.dialScaleFont = "bold 10px Trebuchet MS";
    sGauge.props.dialTitle = "Temperature";
    sGauge.props.dialTitleTextFont = "bold 12px Calibri";
    sGauge.props.dialValueTextFont = "bold 14px Arial Black";
    sGauge.props.dialSubTitle = "Centigrade";
    sGauge.props.rimWidth = "3";
    sGauge.props.dialSubTitleTextFont = "10px Tahoma";
    sGauge.props.rangeSegments = [{ start: -20, end: 0, color: "blue" },
                                      { start: 0, end: 50, color: "yellow" },

                                      { start: 50, end: 80, color: "red"}];
